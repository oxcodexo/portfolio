        ...
        {flows.map((stepItem) => {
          ...
          return (
            <motion.button
              ...
              className={`flex items-center justify-between p-4 rounded-xl text-left font-mono text-xs transition-all duration-200 border cursor-pointer ${
                isActive
        ...
        return (
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="cyber-card rounded-2xl p-6 md:p-8 flex flex-col gap-6 relative overflow-hidden"
            >
              {/* Background Ambient Glow */}
              <div className="absolute -top-10 -right-10 h-48 w-48 rounded-full bg-emerald-500/10 blur-3xl pointer-events-none glow-breathe" />
              ...
              <div className="flex items-center justify-between pb-4 border-b border-zinc-800/80">
                ...
                <div className="hidden sm:flex items-center gap-2 px-3 py-1 rounded-md bg-zinc-900/80 border border-zinc-800 text-[11px] font-mono text-zinc-400">
                  <Terminal className="h-3.5 w-3.5 text-emerald-400 telemetry-pulse" />
