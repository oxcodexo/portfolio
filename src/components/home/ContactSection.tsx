...
export function ContactSection() {
  return (
    <section id="contact" className="relative flex flex-col gap-8 py-12 border-t border-zinc-800/60">
      {/* Section Header */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
        ...
        <Link
          ...
          className="cyber-card rounded-2xl p-6 flex flex-col justify-between gap-6 group hover:border-cyan-500/50 transition-all"
        >
          <div className="flex flex-col gap-3">
            <div className="flex items-center justify-between">
